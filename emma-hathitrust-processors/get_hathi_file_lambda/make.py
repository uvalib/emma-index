...
FUNCTION_NAMES = {'get': 'hathitrust-get-file'}

FUNCTION_FILE_NAMES = {'get': 'get_hathi_file.py' }
...
if task_param == 'help':
    ...
    if task_param == 'test':
        result_code = print_and_run('pipenv run python -m pytest '
                                    ...
                                    + '--junitxml=test-reports/junit-get-hathi-file.xml '
                                    + '--log-file=test-reports/logs-get-hathi-file.txt')
    ...
    for env in envs:
        ...
        if env in ENV_LIST:
            ...
            if task_param == 'package':
                ...
                print_and_run('aws lambda update-function-code --profile emmalive --function-name ' + function_name_env
                              + ' --zip-file fileb://deploy/' + function_name_env + '.zip')
